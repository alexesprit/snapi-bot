...
registerCommand(popupControl, u'оповещения', 30, u'Отключает (0) или включает (1) сообщения о рестартах/выключениях, а также глобальные новости. Без параметра покажет текущее значение', u'оповещения [0/1]', (u'оповещения', u'оповещения 0'), CHAT);
