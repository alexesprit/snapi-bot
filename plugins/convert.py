...
registerCommandHandler(convertValues, u'перевести', 10, u'Перевод валют. "валюты" в качестве параметра покажет список валют для перевода', u'перевести <из> <в> <кол-во>', (u'перевести RUR USD 100.5', u'перевести валюты'), ANY | PARAM);
