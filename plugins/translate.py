...
registerCommand(translateText, u'перевод', 10, u'Перевод текста с одного языка на другой', u'перевод <исходный_язык> <нужный_язык> <фраза>', (u'перевод en ru hello', u'перевод ru en привет'), ANY | PARAM);
