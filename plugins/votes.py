	...
	if param:
		if gVote[conference] and gVote[conference]["state"] != VOTE_FINISHED:
			...
			sendMsg(msgType, conference, nick, 
				u"Голосование создано! Чтобы добавить пункты напиши \"пункт+ твой_пункт\", удалить - \"пункт- номер пункта\". Начать голосование - команда \"голосование+\". Посмотреть текущие результаты - команда \"мнения\". Окончить голосование - команда \"итоги\"")
	else:
		if gVote[conference]:
			if gVote[conference]["state"] == VOTE_FINISHED:
