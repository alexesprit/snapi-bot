...
opinionTemplate = u'%d) %s (%s голосов)';
...
registerCommand(createVote, u'голосование+', 11, u'Создаёт новое голосование', u'голосование+ <текст>\n<пункт>\n<пункт>\n...', (u'голосование винды - сакс!\nда\nнет!!'), CHAT | PARAM);
registerCommand(deleteVote, u'голосование-', 11, u'Удаляет голосование', u'голосование- <номер>', (u'голосование- 5', ), CHAT | PARAM);
registerCommand(showVotes, u'голосования', 11, u'Показывает все голосования или какое-либо одно', u'голосование [номер]', (u'голосование', u'голосование 4'), CHAT);
registerCommand(vote, u'мнение', 11, u'Для подачи мнения в голосовании', u'мнение <номер_голосования> <номер_пункта>', (u'мнение 2 4', ), CHAT | PARAM);
registerCommand(showOpinions, u'мнения', 11, u'Отдаёт текущие результаты голосования в приват, не завершая голосования при этом', u'мнения [номер]', (u'мнения', u'мнения 5'), CHAT);
registerCommand(endVote, u'итоги', 11, u'Завершает голосование и выдает результаты', u'итоги [номер]', (u'итоги', u'итоги 5'), CHAT);
